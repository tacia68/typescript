...
const contaJoana: Conta = new Conta("1029-x", 0, joana);
...
const contaMatheus: Conta = new Conta("90201-x", 0, matheus);
...
const contaMaria: Conta = new Conta("2020-x", 0, maria);
...
const contaCarlos: Conta = new Conta("5050-x", 0, carlos);
...
const contaPedro: Conta = new Conta("6060-x", 0, pedro);
...
const contaFernanda: Conta = new Conta("7070-x", 0, fernanda);
...
const contaJose: Conta = new Conta("8080-x", 0, jose);
...
const contaMariana: Conta = new Conta("9090-x", 0, mariana);
...
const contaGabriel: Conta = new Conta("1010-x", 0, gabriel);
...
const contaAnaPaula: Conta = new Conta("1111-x", 0, anaPaula);
